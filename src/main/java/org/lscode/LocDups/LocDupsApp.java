...
public final class LocDupsApp implements Observer {

    private final DupLocator dupLocator;

    private final Map<DupLocator.Stage, Map<DupLocator.Phase, String>> phaseMsgs;

    LocDupsApp(DupLocator dupLocator){
